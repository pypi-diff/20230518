# Comparing `tmp/mathtranslate-2.2.2.tar.gz` & `tmp/mathtranslate-2.2.3.tar.gz`
...
### Comparing `mathtranslate-2.2.2/mathtranslate/process_text.py` & `mathtranslate-2.2.3/mathtranslate/process_text.py`
