# Comparing `tmp/TimeForge-0.1.7.tar.gz` & `tmp/TimeForge-0.1.8.tar.gz`
...
## Comparing `TimeForge-0.1.7.tar` & `TimeForge-0.1.8.tar`
...
### Comparing `TimeForge-0.1.7/LICENSE.md` & `TimeForge-0.1.8/LICENSE.md`

 * *Files identical despite different names*

### Comparing `TimeForge-0.1.7/PKG-INFO` & `TimeForge-0.1.8/PKG-INFO`
...
### Comparing `TimeForge-0.1.7/README.md` & `TimeForge-0.1.8/README.md`

 * *Files identical despite different names*

### Comparing `TimeForge-0.1.7/pyproject.toml` & `TimeForge-0.1.8/pyproject.toml`
...
### Comparing `TimeForge-0.1.7/src/TimeForge.egg-info/PKG-INFO` & `TimeForge-0.1.8/src/TimeForge.egg-info/PKG-INFO`
...
### Comparing `TimeForge-0.1.7/src/timeforge/__main__.py` & `TimeForge-0.1.8/src/timeforge/__main__.py`
