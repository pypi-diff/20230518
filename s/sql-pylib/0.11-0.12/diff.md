# Comparing `tmp/sql-pylib-0.11.tar.gz` & `tmp/sql-pylib-0.12.tar.gz`
...
## Comparing `sql-pylib-0.11.tar` & `sql-pylib-0.12.tar`
...
### Comparing `sql-pylib-0.11/setup.py` & `sql-pylib-0.12/setup.py`
...
### Comparing `sql-pylib-0.11/sql_pylib/database_download_upload.py` & `sql-pylib-0.12/sql_pylib/database_download_upload.py`

 * *Files identical despite different names*

### Comparing `sql-pylib-0.11/sql_pylib/load_from_redshift_to_pandas.py` & `sql-pylib-0.12/sql_pylib/load_from_redshift_to_pandas.py`

 * *Files identical despite different names*

### Comparing `sql-pylib-0.11/sql_pylib/sql_builder.py` & `sql-pylib-0.12/sql_pylib/sql_builder.py`
