# Comparing `tmp/stix_shifter_modules_aws_athena-5.3.0-py2.py3-none-any.whl.zip` & `tmp/stix_shifter_modules_aws_athena-5.3.0.dev824-py2.py3-none-any.whl.zip`
 ...
 * *Similarity: 0.9999784779614325%*

 * *Differences: {"'connection'": "{'options': {'mapping': {'default': {'guardduty_to_stix_map': "*

 * *                 "OrderedDict([('resource_instancedetails_networkinterfaces_0_privateipaddress', "*

 * *                 "[OrderedDict([('key', 'ipv4-addr.value'), ('object', 'nc_private_ip1')]), "*

 * *                 "OrderedDict([('key', 'network-traffic.src_ref'), ('object', 'nc_nt'), "*

 * *                 "('references', 'nc_private_ip1')]), OrderedDict([('key', "*

 * *                 "'domain-name.resolves_to_refs'), ('object', 'private […]*
 ...
 * *Differences: {'replace': "OrderedDict([('_time', [OrderedDict([('key', 'first_observed'), ('cybox', False), "*

 * *            "('transformer', 'EpochToTimestamp')]), OrderedDict([('key', 'last_observed'), "*

 * *            "('cybox', False), ('transformer', 'EpochToTimestamp')]), OrderedDict([('key', "*

 * *            "'x-ibm-finding.time_observed'), ('object', 'ibm_finding'), ('transformer', "*

 * *            "'EpochToTimestamp')])]), ('activity', OrderedDict([('key', 'x-oca-event.action'), "*
...
## Comparing `stix_shifter_modules_aws_athena-5.3.0.dist-info/LICENSE.md` & `stix_shifter_modules_aws_athena-5.3.0.dev824.dist-info/LICENSE.md`

 * *Files identical despite different names*

## Comparing `stix_shifter_modules_aws_athena-5.3.0.dist-info/METADATA` & `stix_shifter_modules_aws_athena-5.3.0.dev824.dist-info/METADATA`
...
## Comparing `stix_shifter_modules_aws_athena-5.3.0.dist-info/NOTICE` & `stix_shifter_modules_aws_athena-5.3.0.dev824.dist-info/NOTICE`

 * *Files identical despite different names*

## Comparing `stix_shifter_modules_aws_athena-5.3.0.dist-info/RECORD` & `stix_shifter_modules_aws_athena-5.3.0.dev824.dist-info/RECORD`
