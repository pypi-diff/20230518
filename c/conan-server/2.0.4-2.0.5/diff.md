# Comparing `tmp/conan-server-2.0.4.tar.gz` & `tmp/conan-server-2.0.5.tar.gz`
...
## Comparing `conan-server-2.0.4.tar` & `conan-server-2.0.5.tar`
...
### Comparing `conan-server-2.0.4/LICENSE.md` & `conan-server-2.0.5/LICENSE.md`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/PKG-INFO` & `conan-server-2.0.5/PKG-INFO`
...
### Comparing `conan-server-2.0.4/README.md` & `conan-server-2.0.5/README.md`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/conan_api.py` & `conan-server-2.0.5/conan/api/conan_api.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/model.py` & `conan-server-2.0.5/conan/api/model.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/output.py` & `conan-server-2.0.5/conan/api/output.py`
...
### Comparing `conan-server-2.0.4/conan/api/subapi/cache.py` & `conan-server-2.0.5/conan/api/subapi/cache.py`
...
### Comparing `conan-server-2.0.4/conan/api/subapi/config.py` & `conan-server-2.0.5/conan/api/subapi/config.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/subapi/download.py` & `conan-server-2.0.5/conan/api/subapi/download.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/subapi/export.py` & `conan-server-2.0.5/conan/api/subapi/export.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/subapi/graph.py` & `conan-server-2.0.5/conan/api/subapi/graph.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/subapi/install.py` & `conan-server-2.0.5/conan/api/subapi/install.py`
...
### Comparing `conan-server-2.0.4/conan/api/subapi/list.py` & `conan-server-2.0.5/conan/api/subapi/list.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/subapi/local.py` & `conan-server-2.0.5/conan/api/subapi/local.py`
...
### Comparing `conan-server-2.0.4/conan/api/subapi/lockfile.py` & `conan-server-2.0.5/conan/api/subapi/lockfile.py`
...
### Comparing `conan-server-2.0.4/conan/api/subapi/new.py` & `conan-server-2.0.5/conan/api/subapi/new.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/subapi/profiles.py` & `conan-server-2.0.5/conan/api/subapi/profiles.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/subapi/remotes.py` & `conan-server-2.0.5/conan/api/subapi/remotes.py`
...
### Comparing `conan-server-2.0.4/conan/api/subapi/remove.py` & `conan-server-2.0.5/conan/api/subapi/remove.py`
...
### Comparing `conan-server-2.0.4/conan/api/subapi/search.py` & `conan-server-2.0.5/conan/api/subapi/search.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/api/subapi/upload.py` & `conan-server-2.0.5/conan/api/subapi/upload.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/args.py` & `conan-server-2.0.5/conan/cli/args.py`
...
### Comparing `conan-server-2.0.4/conan/cli/cli.py` & `conan-server-2.0.5/conan/cli/cli.py`
...
### Comparing `conan-server-2.0.4/conan/cli/command.py` & `conan-server-2.0.5/conan/cli/command.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/build.py` & `conan-server-2.0.5/conan/cli/commands/build.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/cache.py` & `conan-server-2.0.5/conan/cli/commands/cache.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/config.py` & `conan-server-2.0.5/conan/cli/commands/config.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/create.py` & `conan-server-2.0.5/conan/cli/commands/create.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/download.py` & `conan-server-2.0.5/conan/cli/commands/download.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/editable.py` & `conan-server-2.0.5/conan/cli/commands/editable.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/export.py` & `conan-server-2.0.5/conan/cli/commands/export.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/export_pkg.py` & `conan-server-2.0.5/conan/cli/commands/export_pkg.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/graph.py` & `conan-server-2.0.5/conan/cli/commands/graph.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/install.py` & `conan-server-2.0.5/conan/cli/commands/install.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/list.py` & `conan-server-2.0.5/conan/cli/commands/list.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/lock.py` & `conan-server-2.0.5/conan/cli/commands/lock.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/new.py` & `conan-server-2.0.5/conan/cli/commands/new.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/profile.py` & `conan-server-2.0.5/conan/cli/commands/profile.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/remote.py` & `conan-server-2.0.5/conan/cli/commands/remote.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/remove.py` & `conan-server-2.0.5/conan/cli/commands/remove.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/search.py` & `conan-server-2.0.5/conan/cli/commands/search.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/source.py` & `conan-server-2.0.5/conan/cli/commands/source.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/commands/test.py` & `conan-server-2.0.5/conan/cli/commands/test.py`
...
### Comparing `conan-server-2.0.4/conan/cli/commands/upload.py` & `conan-server-2.0.5/conan/cli/commands/upload.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/formatters/graph/graph.py` & `conan-server-2.0.5/conan/cli/formatters/graph/graph.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/formatters/graph/graph_info_text.py` & `conan-server-2.0.5/conan/cli/formatters/graph/graph_info_text.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/formatters/graph/info_graph_html.py` & `conan-server-2.0.5/conan/cli/formatters/graph/info_graph_html.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/formatters/list/binary_html_table.py` & `conan-server-2.0.5/conan/cli/formatters/list/binary_html_table.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/formatters/list/list.py` & `conan-server-2.0.5/conan/cli/formatters/list/list.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/formatters/list/search_table_html.py` & `conan-server-2.0.5/conan/cli/formatters/list/search_table_html.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/cli/printers/graph.py` & `conan-server-2.0.5/conan/cli/printers/graph.py`
...
### Comparing `conan-server-2.0.4/conan/internal/api/new/autoools_exe.py` & `conan-server-2.0.5/conan/internal/api/new/autoools_exe.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/autotools_lib.py` & `conan-server-2.0.5/conan/internal/api/new/autotools_lib.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/basic.py` & `conan-server-2.0.5/conan/internal/api/new/basic.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/bazel_exe.py` & `conan-server-2.0.5/conan/internal/api/new/bazel_exe.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/bazel_lib.py` & `conan-server-2.0.5/conan/internal/api/new/bazel_lib.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/cmake_exe.py` & `conan-server-2.0.5/conan/internal/api/new/cmake_exe.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/cmake_lib.py` & `conan-server-2.0.5/conan/internal/api/new/cmake_lib.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/meson_exe.py` & `conan-server-2.0.5/conan/internal/api/new/meson_exe.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/meson_lib.py` & `conan-server-2.0.5/conan/internal/api/new/meson_lib.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/msbuild_exe.py` & `conan-server-2.0.5/conan/internal/api/new/msbuild_exe.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/api/new/msbuild_lib.py` & `conan-server-2.0.5/conan/internal/api/new/msbuild_lib.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/cache/cache.py` & `conan-server-2.0.5/conan/internal/cache/cache.py`
...
### Comparing `conan-server-2.0.4/conan/internal/cache/conan_reference_layout.py` & `conan-server-2.0.5/conan/internal/cache/conan_reference_layout.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/cache/db/cache_database.py` & `conan-server-2.0.5/conan/internal/cache/db/cache_database.py`
...
### Comparing `conan-server-2.0.4/conan/internal/cache/db/packages_table.py` & `conan-server-2.0.5/conan/internal/cache/db/packages_table.py`
...
### Comparing `conan-server-2.0.4/conan/internal/cache/db/recipes_table.py` & `conan-server-2.0.5/conan/internal/cache/db/recipes_table.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/cache/db/table.py` & `conan-server-2.0.5/conan/internal/cache/db/table.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/conan_app.py` & `conan-server-2.0.5/conan/internal/conan_app.py`
...
### Comparing `conan-server-2.0.4/conan/internal/deploy.py` & `conan-server-2.0.5/conan/internal/deploy.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/internal/integrity_check.py` & `conan-server-2.0.5/conan/internal/integrity_check.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/android/utils.py` & `conan-server-2.0.5/conan/tools/android/utils.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/apple/__init__.py` & `conan-server-2.0.5/conan/tools/apple/__init__.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/apple/apple.py` & `conan-server-2.0.5/conan/tools/apple/apple.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/apple/xcodebuild.py` & `conan-server-2.0.5/conan/tools/apple/xcodebuild.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/apple/xcodedeps.py` & `conan-server-2.0.5/conan/tools/apple/xcodedeps.py`
...
### Comparing `conan-server-2.0.4/conan/tools/apple/xcodetoolchain.py` & `conan-server-2.0.5/conan/tools/apple/xcodetoolchain.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/build/__init__.py` & `conan-server-2.0.5/conan/tools/build/__init__.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/build/cppstd.py` & `conan-server-2.0.5/conan/tools/build/cppstd.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/build/cpu.py` & `conan-server-2.0.5/conan/tools/build/cpu.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/build/cross_building.py` & `conan-server-2.0.5/conan/tools/build/cross_building.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/build/flags.py` & `conan-server-2.0.5/conan/tools/build/flags.py`
...
### Comparing `conan-server-2.0.4/conan/tools/build/stdcpp_library.py` & `conan-server-2.0.5/conan/tools/build/stdcpp_library.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/cmake.py` & `conan-server-2.0.5/conan/tools/cmake/cmake.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/cmakedeps/cmakedeps.py` & `conan-server-2.0.5/conan/tools/cmake/cmakedeps/cmakedeps.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/cmakedeps/templates/__init__.py` & `conan-server-2.0.5/conan/tools/cmake/cmakedeps/templates/__init__.py`
...
### Comparing `conan-server-2.0.4/conan/tools/cmake/cmakedeps/templates/config.py` & `conan-server-2.0.5/conan/tools/cmake/cmakedeps/templates/config.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/cmakedeps/templates/config_version.py` & `conan-server-2.0.5/conan/tools/cmake/cmakedeps/templates/config_version.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/cmakedeps/templates/macros.py` & `conan-server-2.0.5/conan/tools/cmake/cmakedeps/templates/macros.py`
...
### Comparing `conan-server-2.0.4/conan/tools/cmake/cmakedeps/templates/target_configuration.py` & `conan-server-2.0.5/conan/tools/cmake/cmakedeps/templates/target_configuration.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/cmakedeps/templates/target_data.py` & `conan-server-2.0.5/conan/tools/cmake/cmakedeps/templates/target_data.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/cmakedeps/templates/targets.py` & `conan-server-2.0.5/conan/tools/cmake/cmakedeps/templates/targets.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/file_api.py` & `conan-server-2.0.5/conan/tools/cmake/file_api.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/layout.py` & `conan-server-2.0.5/conan/tools/cmake/layout.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/presets.py` & `conan-server-2.0.5/conan/tools/cmake/presets.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/cmake/toolchain/blocks.py` & `conan-server-2.0.5/conan/tools/cmake/toolchain/blocks.py`
...
### Comparing `conan-server-2.0.4/conan/tools/cmake/toolchain/toolchain.py` & `conan-server-2.0.5/conan/tools/cmake/toolchain/toolchain.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/env/environment.py` & `conan-server-2.0.5/conan/tools/env/environment.py`
...
### Comparing `conan-server-2.0.4/conan/tools/env/virtualbuildenv.py` & `conan-server-2.0.5/conan/tools/env/virtualbuildenv.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/env/virtualrunenv.py` & `conan-server-2.0.5/conan/tools/env/virtualrunenv.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/files/__init__.py` & `conan-server-2.0.5/conan/tools/files/__init__.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/files/conandata.py` & `conan-server-2.0.5/conan/tools/files/conandata.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/files/copy_pattern.py` & `conan-server-2.0.5/conan/tools/files/copy_pattern.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/files/cpp_package.py` & `conan-server-2.0.5/conan/tools/files/cpp_package.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/files/files.py` & `conan-server-2.0.5/conan/tools/files/files.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/files/packager.py` & `conan-server-2.0.5/conan/tools/files/packager.py`
...
### Comparing `conan-server-2.0.4/conan/tools/files/patches.py` & `conan-server-2.0.5/conan/tools/files/patches.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/files/symlinks/symlinks.py` & `conan-server-2.0.5/conan/tools/files/symlinks/symlinks.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/gnu/autotools.py` & `conan-server-2.0.5/conan/tools/gnu/autotools.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/gnu/autotoolsdeps.py` & `conan-server-2.0.5/conan/tools/gnu/autotoolsdeps.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/gnu/autotoolstoolchain.py` & `conan-server-2.0.5/conan/tools/gnu/autotoolstoolchain.py`
...
### Comparing `conan-server-2.0.4/conan/tools/gnu/get_gnu_triplet.py` & `conan-server-2.0.5/conan/tools/gnu/get_gnu_triplet.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/gnu/gnudeps_flags.py` & `conan-server-2.0.5/conan/tools/gnu/gnudeps_flags.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/gnu/pkgconfig.py` & `conan-server-2.0.5/conan/tools/gnu/pkgconfig.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/gnu/pkgconfigdeps.py` & `conan-server-2.0.5/conan/tools/gnu/pkgconfigdeps.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/google/bazel.py` & `conan-server-2.0.5/conan/tools/google/bazel.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/google/bazeldeps.py` & `conan-server-2.0.5/conan/tools/google/bazeldeps.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/google/layout.py` & `conan-server-2.0.5/conan/tools/google/layout.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/google/toolchain.py` & `conan-server-2.0.5/conan/tools/google/toolchain.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/intel/intel_cc.py` & `conan-server-2.0.5/conan/tools/intel/intel_cc.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/layout/__init__.py` & `conan-server-2.0.5/conan/tools/layout/__init__.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/meson/helpers.py` & `conan-server-2.0.5/conan/tools/meson/helpers.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/meson/meson.py` & `conan-server-2.0.5/conan/tools/meson/meson.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/meson/toolchain.py` & `conan-server-2.0.5/conan/tools/meson/toolchain.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/__init__.py` & `conan-server-2.0.5/conan/tools/microsoft/__init__.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/layout.py` & `conan-server-2.0.5/conan/tools/microsoft/layout.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/msbuild.py` & `conan-server-2.0.5/conan/tools/microsoft/msbuild.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/msbuilddeps.py` & `conan-server-2.0.5/conan/tools/microsoft/msbuilddeps.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/nmakedeps.py` & `conan-server-2.0.5/conan/tools/microsoft/nmakedeps.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/nmaketoolchain.py` & `conan-server-2.0.5/conan/tools/microsoft/nmaketoolchain.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/subsystems.py` & `conan-server-2.0.5/conan/tools/microsoft/subsystems.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/toolchain.py` & `conan-server-2.0.5/conan/tools/microsoft/toolchain.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/microsoft/visual.py` & `conan-server-2.0.5/conan/tools/microsoft/visual.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/premake/premake.py` & `conan-server-2.0.5/conan/tools/premake/premake.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/premake/premakedeps.py` & `conan-server-2.0.5/conan/tools/premake/premakedeps.py`
...
### Comparing `conan-server-2.0.4/conan/tools/qbs/qbs.py` & `conan-server-2.0.5/conan/tools/qbs/qbs.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/qbs/qbsprofile.py` & `conan-server-2.0.5/conan/tools/qbs/qbsprofile.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/scm/git.py` & `conan-server-2.0.5/conan/tools/scm/git.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan/tools/system/package_manager.py` & `conan-server-2.0.5/conan/tools/system/package_manager.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan_server.egg-info/PKG-INFO` & `conan-server-2.0.5/conan_server.egg-info/PKG-INFO`
...
### Comparing `conan-server-2.0.4/conan_server.egg-info/SOURCES.txt` & `conan-server-2.0.5/conan_server.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conan_server.egg-info/requires.txt` & `conan-server-2.0.5/conan_server.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/cache/cache.py` & `conan-server-2.0.5/conans/client/cache/cache.py`
...
### Comparing `conan-server-2.0.4/conans/client/cache/editable.py` & `conan-server-2.0.5/conans/client/cache/editable.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/cache/remote_registry.py` & `conan-server-2.0.5/conans/client/cache/remote_registry.py`
...
### Comparing `conan-server-2.0.4/conans/client/cmd/export.py` & `conan-server-2.0.5/conans/client/cmd/export.py`
...
### Comparing `conan-server-2.0.4/conans/client/cmd/uploader.py` & `conan-server-2.0.5/conans/client/cmd/uploader.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/cmd/user.py` & `conan-server-2.0.5/conans/client/cmd/user.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/conanfile/build.py` & `conan-server-2.0.5/conans/client/conanfile/build.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/conanfile/configure.py` & `conan-server-2.0.5/conans/client/conanfile/configure.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/conanfile/package.py` & `conan-server-2.0.5/conans/client/conanfile/package.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/conf/__init__.py` & `conan-server-2.0.5/conans/client/conf/__init__.py`
...
### Comparing `conan-server-2.0.4/conans/client/conf/config_installer.py` & `conan-server-2.0.5/conans/client/conf/config_installer.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/conf/detect.py` & `conan-server-2.0.5/conans/client/conf/detect.py`
...
### Comparing `conan-server-2.0.4/conans/client/conf/detect_vs.py` & `conan-server-2.0.5/conans/client/conf/detect_vs.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/conf/required_version.py` & `conan-server-2.0.5/conans/client/conf/required_version.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/downloaders/caching_file_downloader.py` & `conan-server-2.0.5/conans/client/downloaders/caching_file_downloader.py`
...
### Comparing `conan-server-2.0.4/conans/client/downloaders/download_cache.py` & `conan-server-2.0.5/conans/client/downloaders/download_cache.py`
...
### Comparing `conan-server-2.0.4/conans/client/downloaders/file_downloader.py` & `conan-server-2.0.5/conans/client/downloaders/file_downloader.py`
...
### Comparing `conan-server-2.0.4/conans/client/generators/__init__.py` & `conan-server-2.0.5/conans/client/generators/__init__.py`
...
### Comparing `conan-server-2.0.4/conans/client/graph/build_mode.py` & `conan-server-2.0.5/conans/client/graph/build_mode.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/graph/compatibility.py` & `conan-server-2.0.5/conans/client/graph/compatibility.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/graph/compute_pid.py` & `conan-server-2.0.5/conans/client/graph/compute_pid.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/graph/graph.py` & `conan-server-2.0.5/conans/client/graph/graph.py`
...
### Comparing `conan-server-2.0.4/conans/client/graph/graph_binaries.py` & `conan-server-2.0.5/conans/client/graph/graph_binaries.py`
...
### Comparing `conan-server-2.0.4/conans/client/graph/graph_builder.py` & `conan-server-2.0.5/conans/client/graph/graph_builder.py`
...
### Comparing `conan-server-2.0.4/conans/client/graph/graph_error.py` & `conan-server-2.0.5/conans/client/graph/graph_error.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/graph/install_graph.py` & `conan-server-2.0.5/conans/client/graph/install_graph.py`
...
### Comparing `conan-server-2.0.4/conans/client/graph/profile_node_definer.py` & `conan-server-2.0.5/conans/client/graph/profile_node_definer.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/graph/provides.py` & `conan-server-2.0.5/conans/client/graph/provides.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/graph/proxy.py` & `conan-server-2.0.5/conans/client/graph/proxy.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/graph/python_requires.py` & `conan-server-2.0.5/conans/client/graph/python_requires.py`
...
### Comparing `conan-server-2.0.4/conans/client/graph/range_resolver.py` & `conan-server-2.0.5/conans/client/graph/range_resolver.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/hook_manager.py` & `conan-server-2.0.5/conans/client/hook_manager.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/installer.py` & `conan-server-2.0.5/conans/client/installer.py`
...
### Comparing `conan-server-2.0.4/conans/client/loader.py` & `conan-server-2.0.5/conans/client/loader.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/loader_txt.py` & `conan-server-2.0.5/conans/client/loader_txt.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/migrations.py` & `conan-server-2.0.5/conans/client/migrations.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/pkg_sign.py` & `conan-server-2.0.5/conans/client/pkg_sign.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/profile_loader.py` & `conan-server-2.0.5/conans/client/profile_loader.py`
...
### Comparing `conan-server-2.0.4/conans/client/remote_manager.py` & `conan-server-2.0.5/conans/client/remote_manager.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/rest/__init__.py` & `conan-server-2.0.5/conans/client/rest/__init__.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/rest/auth_manager.py` & `conan-server-2.0.5/conans/client/rest/auth_manager.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/rest/client_routes.py` & `conan-server-2.0.5/conans/client/rest/client_routes.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/rest/conan_requester.py` & `conan-server-2.0.5/conans/client/rest/conan_requester.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/rest/file_uploader.py` & `conan-server-2.0.5/conans/client/rest/file_uploader.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/rest/rest_client.py` & `conan-server-2.0.5/conans/client/rest/rest_client.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/rest/rest_client_common.py` & `conan-server-2.0.5/conans/client/rest/rest_client_common.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/rest/rest_client_v2.py` & `conan-server-2.0.5/conans/client/rest/rest_client_v2.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/source.py` & `conan-server-2.0.5/conans/client/source.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/store/localdb.py` & `conan-server-2.0.5/conans/client/store/localdb.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/subsystems.py` & `conan-server-2.0.5/conans/client/subsystems.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/client/userio.py` & `conan-server-2.0.5/conans/client/userio.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/conan_server.py` & `conan-server-2.0.5/conans/conan_server.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/errors.py` & `conan-server-2.0.5/conans/errors.py`
...
### Comparing `conan-server-2.0.4/conans/migrations.py` & `conan-server-2.0.5/conans/migrations.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/build_info.py` & `conan-server-2.0.5/conans/model/build_info.py`
...
### Comparing `conan-server-2.0.4/conans/model/conan_file.py` & `conan-server-2.0.5/conans/model/conan_file.py`
...
### Comparing `conan-server-2.0.4/conans/model/conanfile_interface.py` & `conan-server-2.0.5/conans/model/conanfile_interface.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/conf.py` & `conan-server-2.0.5/conans/model/conf.py`
...
### Comparing `conan-server-2.0.4/conans/model/dependencies.py` & `conan-server-2.0.5/conans/model/dependencies.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/graph_lock.py` & `conan-server-2.0.5/conans/model/graph_lock.py`
...
### Comparing `conan-server-2.0.4/conans/model/info.py` & `conan-server-2.0.5/conans/model/info.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/layout.py` & `conan-server-2.0.5/conans/model/layout.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/manifest.py` & `conan-server-2.0.5/conans/model/manifest.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/options.py` & `conan-server-2.0.5/conans/model/options.py`
...
### Comparing `conan-server-2.0.4/conans/model/package_ref.py` & `conan-server-2.0.5/conans/model/package_ref.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/pkg_type.py` & `conan-server-2.0.5/conans/model/pkg_type.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/profile.py` & `conan-server-2.0.5/conans/model/profile.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/recipe_ref.py` & `conan-server-2.0.5/conans/model/recipe_ref.py`
...
### Comparing `conan-server-2.0.4/conans/model/requires.py` & `conan-server-2.0.5/conans/model/requires.py`
...
### Comparing `conan-server-2.0.4/conans/model/rest_routes.py` & `conan-server-2.0.5/conans/model/rest_routes.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/settings.py` & `conan-server-2.0.5/conans/model/settings.py`
...
### Comparing `conan-server-2.0.4/conans/model/version.py` & `conan-server-2.0.5/conans/model/version.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/model/version_range.py` & `conan-server-2.0.5/conans/model/version_range.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/paths/__init__.py` & `conan-server-2.0.5/conans/paths/__init__.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/pylint_plugin.py` & `conan-server-2.0.5/conans/pylint_plugin.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/search/query_parse.py` & `conan-server-2.0.5/conans/search/query_parse.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/search/search.py` & `conan-server-2.0.5/conans/search/search.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/conf/__init__.py` & `conan-server-2.0.5/conans/server/conf/__init__.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/conf/default_server_conf.py` & `conan-server-2.0.5/conans/server/conf/default_server_conf.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/crypto/jwt/jwt_credentials_manager.py` & `conan-server-2.0.5/conans/server/crypto/jwt/jwt_credentials_manager.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/crypto/jwt/jwt_manager.py` & `conan-server-2.0.5/conans/server/crypto/jwt/jwt_manager.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/launcher.py` & `conan-server-2.0.5/conans/server/launcher.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/migrate.py` & `conan-server-2.0.5/conans/server/migrate.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/plugin_loader.py` & `conan-server-2.0.5/conans/server/plugin_loader.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/api_v2.py` & `conan-server-2.0.5/conans/server/rest/api_v2.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/bottle_plugins/authorization_header.py` & `conan-server-2.0.5/conans/server/rest/bottle_plugins/authorization_header.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/bottle_plugins/http_basic_authentication.py` & `conan-server-2.0.5/conans/server/rest/bottle_plugins/http_basic_authentication.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/bottle_plugins/jwt_authentication.py` & `conan-server-2.0.5/conans/server/rest/bottle_plugins/jwt_authentication.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/bottle_plugins/return_handler.py` & `conan-server-2.0.5/conans/server/rest/bottle_plugins/return_handler.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/controller/v2/conan.py` & `conan-server-2.0.5/conans/server/rest/controller/v2/conan.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/controller/v2/delete.py` & `conan-server-2.0.5/conans/server/rest/controller/v2/delete.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/controller/v2/revisions.py` & `conan-server-2.0.5/conans/server/rest/controller/v2/revisions.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/controller/v2/search.py` & `conan-server-2.0.5/conans/server/rest/controller/v2/search.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/controller/v2/users.py` & `conan-server-2.0.5/conans/server/rest/controller/v2/users.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/rest/server.py` & `conan-server-2.0.5/conans/server/rest/server.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/revision_list.py` & `conan-server-2.0.5/conans/server/revision_list.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/service/authorize.py` & `conan-server-2.0.5/conans/server/service/authorize.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/service/user_service.py` & `conan-server-2.0.5/conans/server/service/user_service.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/service/v2/search.py` & `conan-server-2.0.5/conans/server/service/v2/search.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/service/v2/service_v2.py` & `conan-server-2.0.5/conans/server/service/v2/service_v2.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/store/disk_adapter.py` & `conan-server-2.0.5/conans/server/store/disk_adapter.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/store/server_store.py` & `conan-server-2.0.5/conans/server/store/server_store.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/server/utils/files.py` & `conan-server-2.0.5/conans/server/utils/files.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/test/conftest.py` & `conan-server-2.0.5/conans/test/conftest.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/test/utils/artifactory.py` & `conan-server-2.0.5/conans/test/utils/artifactory.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/test/utils/mocks.py` & `conan-server-2.0.5/conans/test/utils/mocks.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/test/utils/profiles.py` & `conan-server-2.0.5/conans/test/utils/profiles.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/test/utils/scm.py` & `conan-server-2.0.5/conans/test/utils/scm.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/test/utils/server_launcher.py` & `conan-server-2.0.5/conans/test/utils/server_launcher.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/test/utils/test_files.py` & `conan-server-2.0.5/conans/test/utils/test_files.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/test/utils/tools.py` & `conan-server-2.0.5/conans/test/utils/tools.py`
...
### Comparing `conan-server-2.0.4/conans/util/config_parser.py` & `conan-server-2.0.5/conans/util/config_parser.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/util/dates.py` & `conan-server-2.0.5/conans/util/dates.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/util/encrypt.py` & `conan-server-2.0.5/conans/util/encrypt.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/util/env.py` & `conan-server-2.0.5/conans/util/env.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/util/files.py` & `conan-server-2.0.5/conans/util/files.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/util/locks.py` & `conan-server-2.0.5/conans/util/locks.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/util/runners.py` & `conan-server-2.0.5/conans/util/runners.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/util/sha.py` & `conan-server-2.0.5/conans/util/sha.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/conans/util/windows.py` & `conan-server-2.0.5/conans/util/windows.py`

 * *Files identical despite different names*

### Comparing `conan-server-2.0.4/setup.py` & `conan-server-2.0.5/setup.py`
