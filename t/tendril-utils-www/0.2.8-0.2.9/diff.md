# Comparing `tmp/tendril-utils-www-0.2.8.tar.gz` & `tmp/tendril-utils-www-0.2.9.tar.gz`
...
### Comparing `tendril-utils-www-0.2.8/.readthedocs.yml` & `tendril-utils-www-0.2.9/.readthedocs.yml`
